...
def priority_order(row, df):
    ...
    # Dictionary for simple group mappings
    priority_map = {
        'Power_Positive': "A_Power_Positive",
        'Power_Ref_Positive': "A_Power_Ref_Positive",
        'Analog_Power_Positive': "A_Analog_Power_Positive",
        ...
        'USB_Pins' : 'USB_Pins' ,
        'Mode': "E_ModePins",
        'GPIO_Pins': "G_GPIO_Pins",
        'ADC_Pins': "F_ADC_Pins",
        'Audio_data_lines' : "F_Audio_data_lines",
        'Cutoff': "F_C_Cutoff",
        'Control': "F_CNT_Control",
        'data_lines': "D_Data_Lines",
        'Analog_Input_Pins': "I_Analog_Input_Pins",
        'Chip_Select': "CS_Chip_Select",
        'System_Output': "S_Output",
        'Common_Output': "SC_Output"
    }
    ...
    # Clock-related cases
    clock_map = {
        'Main_Clock': "CA_Main_Clocks/Oscillators",
        'External_Clock': "CB_External_Clocks/Oscillators",
        'Clock_Capacitor': "CC_External_Capacitive_Clocks/Oscillators",
        'Reference_Clk': "CD_Reference_Clocks/Oscillators",
        'On_Chip_Oscillator': "CO_On_Chip_Clocks/Oscillators",
    }
    
    for clock_type, priority in clock_map.items():
    ...
    if row['Electrical Type'] == 'Input' and value.startswith("Port"):
        swap_conditions = {
            'X1': "CA_Main_Clocks/Oscillators",
            'X2': "CA_Main_Clocks/Oscillators",
            'XT': "CB_External_Clocks/Oscillators",
            'MD': "E_ModePins",
            'NMI': "I_Interrupts",
            'VREF': "A_Power_Ref_Positive",
            'VRFF': "A_Power_Ref_Positive"
        }

        for alt_name, priority in swap_conditions.items():
...
def Dual_in_line_as_per_Renesas(df):
    ...
    # Rename the "Changed_grouping" column
    process_dataframe = process_dataframe.rename(columns={'Changed Grouping': 'Group Name'})
